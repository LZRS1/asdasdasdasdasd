          ...
          <div className='lg:col-start-2'>
            ...
            {order._isPaid ? (
              <p className='mt-2 text-base text-muted-foreground'>
                Su pedido fue procesado y sus activos están
                disponible para descargar a continuación. Hemos enviado
                su recibo y detalles del pedido a{' '}
                {typeof order.user !== 'string' ? (
              ...
              <p className='mt-2 text-base text-muted-foreground'>
                ...
                actualmente tramitándolo. Así que agárrate fuerte y
